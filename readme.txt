...
Make sure you have the most up to date versions of arcropolis (https://github.com/Raytwo/ARCropolis/releases) and skyline (https://github.com/skyline-dev/skyline/releases)

Make sure you do NOT have acmd_hook on your sd card

Make sure you've enabled Ultimate S in mod manager

Make sure Ultimate S is not conflicting with other mods (Arcropolis should let you know if it is)
...
mRama - Coding, Animation, Weapon Modelling, UI creation
