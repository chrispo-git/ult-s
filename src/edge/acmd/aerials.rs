...
pub fn install() {
    ...
    .acmd("game_attackairn", seph_nair, Priority::Low)    
    .acmd("game_attackairhi", seph_uair, Priority::Low)    
    .acmd("game_attackairb", seph_bair, Priority::Low)    
    .install();
}
