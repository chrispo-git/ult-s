...
pub fn install() {
	...
	param_config::update_int_2(-*FIGHTER_KIND_PFUSHIGISOU, get_marked_costumes("pfushigisou","pfushigisou").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_leafcutter"), smash::hash40("life"), 75));
