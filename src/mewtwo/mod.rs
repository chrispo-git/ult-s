...
unsafe fn m2_bair_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		...
		frame(fighter.lua_state_agent, 13.0);
		if macros::is_excute(fighter) {
			macros::EFFECT_FOLLOW_FLIP(fighter, Hash40::new("mewtwo_pk_attack_b"), Hash40::new("mewtwo_pk_attack_b"), Hash40::new("handr"), 0, 0, 0, 0, 0, 0, 1, true, *EF_FLIP_YZ);
		}
}		
#[acmd_script(
    agent = "mewtwo",
...
pub fn install() {
    smashline::install_acmd_scripts!(
		m2_bair, m2_bair_eff, m2_bair_snd,
		m2_dash,
		m2_turn_dash,
		m2_uair
    );
