...
pub fn install() {
	Agent::new("pacman")
	.acmd("game_attacks3bomb", bomb_ftilts)
	.acmd("game_attacks3hibomb", bomb_ftilthi)
	.acmd("game_attacks3lwbomb", bomb_ftiltlw)
	.acmd("sound_attacks3bomb", bomb_ftilt_snd)
	.acmd("sound_attacks3hibomb", bomb_ftilt_snd)
	.acmd("sound_attacks3lwbomb", bomb_ftilt_snd)
	.acmd("effect_attacks3bomb", bomb_ftilt_eff)
	.acmd("effect_attacks3hibomb", bomb_ftilt_eff)
	.acmd("effect_attacks3lwbomb", bomb_ftilt_eff)
	.acmd("game_attacklw3bomb", bomb_dtilt)
	.acmd("effect_attacklw3bomb", bomb_dtilt_eff)
	.acmd("sound_attacklw3bomb", bomb_dtilt_snd)
	.acmd("game_attackhi3bomb", bomb_utilt)
	.acmd("sound_attackhi3bomb", bomb_utilt_snd)
	.acmd("effect_attackhi3bomb", bomb_utilt_eff)
	.install();
}
