...
pub fn install() {
	Agent::new("pacman")
	.acmd("game_catchbomb", bomb_catch)
	.acmd("game_catchdashbomb", bomb_catchdash)
	.acmd("game_catchturnbomb", bomb_catchturn)
	.acmd("game_catchattackbomb", bomb_catchattack)
	.acmd("effect_catchbomb", bomb_catch_eff)
	.acmd("effect_catchdashbomb", bomb_catch_eff)
	.acmd("effect_catchturnbomb", bomb_catch_eff)
	.acmd("effect_catchattackbomb", bomb_catchattack_eff)
	.acmd("game_throwlwbomb", bomb_dthrow)
	.acmd("effect_throwlwbomb", bomb_dthrow_eff)
	.acmd("sound_throwlwbomb", bomb_dthrow_snd)
	.acmd("expression_throwlwbomb", bomb_dthrow_expr)
	.acmd("game_throwfbomb", bomb_fthrow)
	.acmd("effect_throwfbomb", bomb_fthrow_eff)
	.acmd("sound_throwfbomb", bomb_fthrow_snd)
	.acmd("game_throwbbomb", bomb_bthrow)
	.acmd("effect_throwbbomb", bomb_bthrow_eff)
	.acmd("sound_throwbbomb", bomb_bthrow_snd)
	.acmd("game_throwhibomb", bomb_uthrow)
	.acmd("effect_throwhibomb", bomb_uthrow_eff)
	.acmd("sound_throwhibomb", bomb_uthrow_snd)
	.install();
}
...
unsafe extern "C" fn bomb_dthrow(fighter: &mut L2CAgentBase) {
		...
		if macros::is_excute(fighter) {
			macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 5.0, /*Angle*/ 74, /*KBG*/ 50, /*FKB*/ 0, /*BKB*/ 65, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
