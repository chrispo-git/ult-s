...
pub fn install() {
    Agent::new("ness")
    .set_costume(get_marked_costumes("ness","ness"))
...
unsafe extern "C" fn ness_dtilt(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn ness_dtilt_eff(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn ness_dtilt_snd(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 5.0);
    if macros::is_excute(agent) {
