...
static EDGE_CANCEL_LIST: Lazy<Vec<EdgeCancelEntry>> = Lazy::new(|| {
    vec![
        EdgeCancelEntry::new(*FIGHTER_KIND_LUCARIO, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("lucario","lucario").into(), get_costume_count("lucario","lucario").into()),
        ...
        EdgeCancelEntry::new(*FIGHTER_KIND_DONKEY, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("donkey","donkey").into(), get_costume_count("donkey","donkey").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_BUDDY, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("buddy","buddy").into(), get_costume_count("buddy","buddy").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_KAMUI, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("kamui","kamui").into(), get_costume_count("kamui","kamui").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_PURIN, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("purin","purin").into(), get_costume_count("purin","purin").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_CAPTAIN, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("captain","captain").into(), get_costume_count("captain","captain").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_RIDLEY, *FIGHTER_STATUS_KIND_LANDING_FALL_SPECIAL, 
             get_lowest_marked_costume("ridley","ridley").into(), get_costume_count("ridley","ridley").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_RICHTER, *FIGHTER_STATUS_KIND_ATTACK_LW3, 
             get_lowest_marked_costume("richter","richter").into(), get_costume_count("richter","richter").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_SAMUS, *FIGHTER_STATUS_KIND_ATTACK_LW3, 
             get_lowest_marked_costume("samus","samus").into(), get_costume_count("samus","samus").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_SONIC, *FIGHTER_STATUS_KIND_SPECIAL_S, 
             get_lowest_marked_costume("sonic","sonic").into(), get_costume_count("sonic","sonic").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_ROY, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("roy","roy").into(), get_costume_count("roy","roy").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_YOUNGLINK, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("younglink","younglink").into(), get_costume_count("younglink","younglink").into()),
        ...
        EdgeCancelEntry::new(*FIGHTER_KIND_EDGE, *FIGHTER_STATUS_KIND_ATTACK_LW3, 
             get_lowest_marked_costume("edge","edge").into(), get_costume_count("edge","edge").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_FALCO, *FIGHTER_STATUS_KIND_ATTACK_DASH, 
             get_lowest_marked_costume("falco","falco").into(), get_costume_count("falco","falco").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_PIKMIN, *FIGHTER_STATUS_KIND_RUN_BRAKE, 
             get_lowest_marked_costume("pikmin","rayman").into(), get_costume_count("pikmin","rayman").into()),
        EdgeCancelEntry::new(*FIGHTER_KIND_MURABITO, *FIGHTER_STATUS_KIND_SPECIAL_S, 
             get_lowest_marked_costume("murabito","toad").into(), get_costume_count("murabito","toad").into()),
        ...
        EdgeCancelEntry::new(*FIGHTER_KIND_INKLING, 25, 
             get_lowest_marked_costume("inkling","inkling").into(), get_costume_count("inkling","inkling").into()),
