...
pub fn install() {
	Agent::new("daisy")
    .acmd("game_speciallw", daisy_downb, Priority::Low)    
    .acmd("effect_speciallw", daisy_downb_eff, Priority::Low)    
    .acmd("game_specialhistart", daisy_upb, Priority::Low)    
    .acmd("game_specialairhistart", daisy_upb, Priority::Low)    
    .acmd("game_specialn", daisy_neutralb, Priority::Low)    
    .acmd("game_specialairn", daisy_neutralb, Priority::Low)    
    .acmd("game_specialnhit", daisy_neutralb_hit, Priority::Low)    
    .acmd("game_specialairnhit", daisy_neutralb_hit, Priority::Low)    
    .acmd("game_specialnturn", daisy_neutralb_hit, Priority::Low)    
    .acmd("game_specialairnturn", daisy_neutralb_hit, Priority::Low)    
    .acmd("effect_specialn", daisy_neutralb_eff, Priority::Low)    
    .acmd("effect_specialairn", daisy_neutralb_eff, Priority::Low)    
    .acmd("effect_specialnhit", daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_specialairnhit", daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_specialnturn", daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_specialairnturn", daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_specialairnturn", daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_specialairnturn", daisy_neutralb_hit_eff, Priority::Low)   
    .acmd("sound_specialairnhit", daisy_neutralb_hit_snd, Priority::Low)    
    .acmd("sound_specialairnhit", daisy_neutralb_hit_snd, Priority::Low)    
    .acmd("sound_specialnturn", daisy_neutralb_hit_snd, Priority::Low)    
    .acmd("sound_specialairnturn", daisy_neutralb_hit_snd, Priority::Low)    
    .acmd("sound_specialairnturn", daisy_neutralb_hit_snd, Priority::Low)    
    .acmd("sound_specialairnturn", daisy_neutralb_hit_snd, Priority::Low)    
    .install();

	Agent::new("kirby")
	.acmd("effect_daisyspecialn", kirby_daisy_neutralb_eff, Priority::Low)    
    .acmd("effect_daisyspecialairn", kirby_daisy_neutralb_eff, Priority::Low)    
    .acmd("effect_daisyspecialnhit", kirby_daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_daisyspecialairnhit", kirby_daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_daisyspecialnturn", kirby_daisy_neutralb_hit_eff, Priority::Low)    
    .acmd("effect_daisyspecialairnturn", kirby_daisy_neutralb_hit_eff, Priority::Low)    
    .install();
}
...
unsafe extern "C" fn daisy_neutralb_hit_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 5.0);
		if macros::is_excute(fighter) {
			macros::EFFECT_FOLLOW(fighter, Hash40::new("daisy_bomber_jamp"), Hash40::new("hip"), 0, 0, 0, 0, 0, 0, 1, true);
...
unsafe extern "C" fn daisy_neutralb_hit_snd(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 5.0);
		if macros::is_excute(fighter) {
			macros::PLAY_SE(fighter, Hash40::new("se_daisy_dash_start"));
			macros::PLAY_SE(fighter, Hash40::new("se_daisy_special_s01"));
		}
		frame(fighter.lua_state_agent, 27.0);
		if macros::is_excute(fighter) {
			macros::PLAY_SE(fighter, Hash40::new("se_daisy_dash_stop"));
		}
}
