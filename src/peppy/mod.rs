...
pub fn install() {
    ...
    the_csk_collection_api::add_chara_layout_db_entry_info(
     ...
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("dash_speed"), 0, 1.92));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("run_speed_max"), 0, 1.65));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("walk_speed_max"), 0, 1.05));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("ground_brake"), 0, 0.08));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("jump_speed_x_mul"), 0, 0.8));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_accel_x_mul"), 0, 0.04));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_accel_x_add"), 0, 0.01));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_speed_x_stable"), 0, 1.09));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_speed_y_stable"), 0, 1.8));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_accel_y"), 0, 0.14));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("dive_speed_y"), 0, 2.88));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("jump_initial_y"), 0, 17.6));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("jump_y"), 0, 32.5));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("mini_jump_y"), 0, 16.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("jump_aerial_y"), 0, 32.5));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("weight"), 0, 92.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_n"), 0, 8.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_f"), 0, 13.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_b"), 0, 11.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_hi"), 0, 8.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_lw"), 0, 10.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_frame"), 0, 4.0));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("shield_radius"), 0, 11.5));
    crate::param_cache::update_int_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("wall_jump_type"), 0, 1));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_hi"), smash::hash40("fire_rush_speed"), 3.9));
    crate::param_cache::update_int_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_hi"), smash::hash40("fire_rush_brake_frame"), 6));
     crate::param_cache::update_float_2(*FIGHTER_KIND_FALCO, get_marked_costumes("falco","peppy").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_hi"), smash::hash40("fire_rush_brake"), 0.09));
