...
pub fn install() {
    ...
    the_csk_collection_api::add_chara_db_entry_info(
        the_csk_collection_api::CharacterDatabaseEntry {
            ...
            color_num: the_csk_collection_api::UnsignedByteType::Overwrite(REGISTRY.get_costume_count("falco","peppy")),
            extra_index_maps: the_csk_collection_api::UnsignedByteMap::Overwrite(HashMap::from([ 
                (smash::hash40("color_start_index") /* Hash40 of color_start_index */, the_csk_collection_api::UnsignedByteType::Overwrite(REGISTRY.get_lowest_marked_costume("falco","peppy")))
            ])),
