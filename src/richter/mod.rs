...
pub fn install() {
	...
	crate::param_cache::update_int_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("life"), 45));
	 ...
	 crate::param_cache::update_float_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_hi"), smash::hash40("start_y_mul_air"), 1.1));
	 crate::param_cache::update_float_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_hi"), smash::hash40("limit_speed_y_air"), 2.1));
	...
	crate::param_cache::update_int_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_holywater"), smash::hash40("fire_pillar_life_frame"), 45));
	 ...
	 crate::param_cache::update_float_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("air_speed_x_stable"), 0, 1.08));
	 ...
	 crate::param_cache::update_float_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_f"), 0, 11.0));
	 crate::param_cache::update_float_2(*FIGHTER_KIND_RICHTER, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("landing_attack_air_frame_b"), 0, 13.0));
