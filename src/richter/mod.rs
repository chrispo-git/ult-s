...
pub fn install() {
	...
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("gravity"), 0.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("throw_angle"), 0.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("throw_speed"), 4.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("brake_x"), 0.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("rot_speed"), 0.0));
	param_config::update_int_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("life"), 45));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("throw_angle_stick_back"), 0.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("throw_angle_stick_front"), 0.0));
	param_config::update_float_2(-*WEAPON_KIND_RICHTER_AXE, get_marked_costumes("richter","richter").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_axe"), smash::hash40("throw_speed_stick_back"), 4.0));
