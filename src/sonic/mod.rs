...
#[acmd_script(
    ...
    category = ACMD_SOUND,
	low_priority)]
unsafe fn sonic_sideb_sound(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
}	
#[acmd_script(
    agent = "sonic",
