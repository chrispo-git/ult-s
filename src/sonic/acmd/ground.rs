...
pub fn install() {
    ...
    .acmd("effect_attacklw4", sonic_dsmash_eff, Priority::Low)    
    .acmd("sound_attacklw4", sonic_dsmash_snd, Priority::Low)    
    .acmd("game_attackhi4", sonic_usmash, Priority::Low)    
    .acmd("sound_attackhi4", sonic_usmash_snd, Priority::Low)    
    .acmd("expression_attackhi4", sonic_usmash_expr, Priority::Low)    
    .acmd("effect_attackhi4", sonic_usmash_eff, Priority::Low)    
    .acmd("game_attackdash", sonic_da, Priority::Low)    
    .acmd("game_attack11", sonic_jab1, Priority::Low)    
    .acmd("game_attack12", sonic_jab2, Priority::Low)    
    .acmd("game_attack100", sonic_rapidjab, Priority::Low)    
    .acmd("effect_attack100", sonic_rapidjab_eff, Priority::Low)    
    .acmd("sound_attack100", sonic_rapidjab_snd, Priority::Low)    
    .acmd("game_attack100end", sonic_rapidjabend, Priority::Low)    
    .install();
}

unsafe extern "C" fn sonic_da_eff(fighter: &mut L2CAgentBase) {
...
unsafe extern "C" fn sonic_jab_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn sonic_dsmash(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		...
		if macros::is_excute(fighter) {
			macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 10.0, /*Angle*/ 32, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 30, /*Size*/ 5.0, /*X*/ 0.0, /*Y*/ 3.6, /*Z*/ 12.0, /*X2*/ Some(0.0), /*Y2*/ Some(3.6), /*Z2*/ Some(4.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
		}
		...
		if macros::is_excute(fighter) {
			macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 8.0, /*Angle*/ 90, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 45, /*Size*/ 5.0, /*X*/ 0.0, /*Y*/ 3.6, /*Z*/ -12.0, /*X2*/ Some(0.0), /*Y2*/ Some(3.6), /*Z2*/ Some(-4.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
		}
...
unsafe extern "C" fn sonic_dsmash_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_dsmash_snd(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn sonic_usmash(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 3.0);
		if macros::is_excute(fighter) {
			WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
...
unsafe extern "C" fn sonic_usmash_snd(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 7.0);
		if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_usmash_expr(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
/*		frame(fighter.lua_state_agent, 7.0);
		if macros::is_excute(fighter) {
			macros::PLAY_SE(fighter, Hash40::new("se_sonic_swing_l"));
...
unsafe extern "C" fn sonic_usmash_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn sonic_da(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 5.0);
		if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_jab1(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 3.0);
		if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_jab2(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn sonic_rapidjab(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		for _ in 0..8 
 {
			if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_rapidjab_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		for _ in 0..2 
 {
			if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_rapidjab_snd(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		for _ in 0..8 
 {
			if macros::is_excute(fighter) {
...
unsafe extern "C" fn sonic_rapidjabend(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		frame(fighter.lua_state_agent, 4.0);
		if macros::is_excute(fighter) {
