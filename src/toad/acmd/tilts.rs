...
unsafe extern "C" fn toad_ftilt_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		...
		if macros::is_excute(fighter) {
        	macros::EFFECT(fighter, Hash40::new("sys_crown"), Hash40::new("top"), 2.5, 0, 0, 0, 0, 0, 0.4, 0, 0, 0, 0, 0, 0, false);
			macros::LANDING_EFFECT(fighter, Hash40::new("sys_soil_landing"), Hash40::new("top"), 2.5, 0, 0, 0, 0, 0, 0.55, 0, 0, 0, 0, 0, 0, false);
		}
...
unsafe extern "C" fn toad_dtilt_eff(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
		...
		if macros::is_excute(fighter) {
			macros::EFFECT_FOLLOW_FLIP_ALPHA(fighter, Hash40::new("sys_attack_arc"), Hash40::new("sys_attack_arc"), Hash40::new("top"), -2, 4, 0, 180, -178, 0, 0.75, true, *EF_FLIP_YZ, 0.3);
		}
}	
