...
pub fn install() {
    ...
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bowlingball"), smash::hash40("is_penetration"), 0));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bullet"), smash::hash40("life"), 21));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bullet"), smash::hash40("gravity"), -0.1));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bullet"), smash::hash40("is_penetration"), 1));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bullet"), smash::hash40("speed"), 0.01));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_bullet"), smash::hash40("limit_speed"), 0.01));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("is_penetration"), 1));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("fly_limit_speed_air"), -1.8));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("fly_gravity"), 0.0));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("fly_limit_gravity"), 0.0));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("fall_start_frame"), 9999999.0));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("rot_limit_speed_air"), 0.0));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("rot_limit_speed_ground"), 0.0));
    param_config::update_float_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_clayrocket"), smash::hash40("fly_limit_speed_ground"), -1.6));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_flowerpot"), smash::hash40("burst_rate"), 0));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_flowerpot"), smash::hash40("life"), 70));
    param_config::update_int_2(-*FIGHTER_KIND_MURABITO, get_marked_costumes("murabito","toad").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_flowerpot"), smash::hash40("is_penetration"), 0));
