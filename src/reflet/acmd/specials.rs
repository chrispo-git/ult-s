...
pub fn install() {
    ...
    .acmd("effect_specialairlwend", robin_downb_end_eff, Priority::Low)    
    .acmd("sound_speciallwstart", robin_downb_snd, Priority::Low)    
    .acmd("sound_specialairlwstart", robin_downb_snd, Priority::Low)    
    .acmd("game_speciallwstart", robin_downb, Priority::Low)    
    .acmd("game_specialairlwstart", robin_downb, Priority::Low)    
    .acmd("game_specialhi3", robin_grima_upb, Priority::Low)    
    .acmd("effect_specialhi3", robin_grima_upb_eff, Priority::Low)    
    .acmd("sound_specialhi3", robin_grima_upb_snd, Priority::Low)    
    .acmd("game_specialnshoot", robin_grima_neutralb, Priority::Low)    
    .acmd("game_specialairnshoot", robin_grima_neutralb, Priority::Low)    
    .acmd("effect_specialnshoot", robin_grima_neutralb_eff, Priority::Low)    
    .acmd("effect_specialairnshoot", robin_grima_neutralb_eff, Priority::Low)    
    .acmd("sound_specialnshoot", robin_grima_neutralb_snd, Priority::Low)    
    .acmd("sound_specialairnshoot", robin_grima_neutralb_snd, Priority::Low)    
    .acmd("game_specials", robin_grima_sideb, Priority::Low)    
    .acmd("game_specialairs", robin_grima_sideb, Priority::Low)    
    .acmd("effect_specials", robin_grima_sideb_eff, Priority::Low)    
    .acmd("effect_specialairs", robin_grima_sideb_eff, Priority::Low)    
    .acmd("sound_specials", robin_grima_sideb_snd, Priority::Low)    
    .acmd("sound_specialairs", robin_grima_sideb_snd, Priority::Low)    
    .install();
