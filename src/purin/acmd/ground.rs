...
pub fn install() {
    Agent::new("purin")
    .set_costume(get_marked_costumes("purin","purin"))
    .acmd("game_attackdash", puff_da, Priority::Low)    
    .acmd("game_attack12", puff_jab2, Priority::Low)    
    .acmd("game_attackhi4", puff_usmash, Priority::Low)    
    .install();
}
