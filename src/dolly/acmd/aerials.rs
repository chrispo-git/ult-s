...
pub fn install() {
    ...
    .acmd("game_attackairn", terry_nair, Priority::Low)    
    .acmd("game_attackairf", terry_fair, Priority::Low)    
    .acmd("game_attackairlw", terry_dair, Priority::Low)    
    .install();
}
