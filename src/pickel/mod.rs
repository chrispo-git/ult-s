...
pub fn install() {
	...
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1a89765685"), 2.5));
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1a0a95e89a"), 0.93));
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1a1bb90606"), 1.25));
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1b78f1e855"), 1.1875));
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1aa714f1ca"), 1.125));
	param_config::update_float_2(*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_special_n"), smash::hash40("0x1da2122271"), 1.0625));
	param_config::update_int_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("lifetime"), 50));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time"), 21.0));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time_add_by_damage"), 0.0));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time_dec_by_clatter"), 0.0));
	param_config::update_int_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("lifetime"), 50));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time"), 21.0));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time_add_by_damage"), 0.0));
	param_config::update_float_2(-*FIGHTER_KIND_PICKEL, get_marked_costumes("pickel","pickel").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_trolley"), smash::hash40("catch_time_dec_by_clatter"), 0.0));
