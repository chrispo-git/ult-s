...
pub fn install() {
	...
	param_config::update_int_2(-*WEAPON_KIND_SHEIK_NEEDLE, get_marked_costumes("sheik","sheik").into_iter().map(|x| x as i32).collect(), (smash::hash40("param_needle"), smash::hash40("life"), 11));
