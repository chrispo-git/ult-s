...
pub fn install() {
	Agent::new("demon")
    .set_costume(get_marked_costumes("demon","demon"))
    .acmd("game_attacks3", kaz_ftilt, Priority::Low)    
	.acmd("game_attacks3lw", kaz_ftilt, Priority::Low)    
	.acmd("game_attacks3hi", kaz_ftilt, Priority::Low)    
    .install();
}
